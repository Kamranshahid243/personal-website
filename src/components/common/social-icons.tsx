 ...
 *
 * Lucide dropped brand marks (GitHub, LinkedIn, X) to avoid trademark issues,
 * so these live here as tiny paths rather than pulling in a second icon
 * library for three logos. Sized by the parent; stroke-free fills so they
 * inherit `currentColor` the same way Lucide icons do.
 */
